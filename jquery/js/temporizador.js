(function ($) {
    $.fn.temporizador = function (opcoes) {
        const opcoesFinais = $.extend({
            ...
            horario: '23:59:59'             // valores padrão
        }, opcoes)
        ...
        const regex = new RegExp(/(\d\d):(\d\d):(\d\d)/)    // três grupos de captura formados por dois digitos e separados por :
        ...
        return this     // para encadear novas chamadas
    }
})(jQuery)